...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "PigPinkyApp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "PigPinkyApp API";

        private String description = "PigPinkyApp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "PigPinkyApp";
